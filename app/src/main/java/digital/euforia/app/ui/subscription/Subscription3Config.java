...
public class Subscription3Config implements Serializable {
    ...
    public Subscription3Config(UserActivity activity) {
        ...
        title = RC.getString(activity.getRC(), "premium_3_title");
