...
val VibesBackground = Color(0xFF17181D)
val White = Color(0xFFFFFFFF)
val PrimaryBackground = Color(0xFF18191D)
val BottomSheetBackground = Color(0xFF202228)
val PrimaryButtonText = Color(0xFF0E1116)
val SoundscapesButtonBackground = Color(0x336D95E3)
val SoundscapesScreenBackground = Color(0xFF18191D)
val SoundscapesSearchDialogBackground = Color(0xFF18191D)
val SoundscapesSearchFieldContainer = Color(0xFF27282C)
val SoundscapesSearchFieldBorder = Color(0x14FFFFFF)
val SoundscapesSearchSuggestionText = Color(0xFF284DEF)
val SoundscapesSearchSuggestionDivider = Color(0x1AFFFFFF)
val SoundscapesCardSurface = Color(0xFF2A2B2F)
val SoundscapesActionButtonBackground = Color(0xFF25262A)
val SoundscapesActionButtonActiveBackground = Color(0xFF4A4C55)
val SoundscapesTileBorder = Color(0x33FFFFFF)
...
val EveningAccompanimentAccent = Color(0xFF0C42AE)
val EveningAccompanimentAccentVariant = Color(0xFF34389A)
val DarkGray = Color(0xFF6A6969)
val ExtraButtonColor = Color(0xFF444343)
...
val eveningColors2 = listOf(
    ...
    Color(0xFF992EA2),  // Фіолетовий
    Color(0xFF0C428E)   // Темно-бірюзовий
)

// Morning кольори
val morningColors = listOf(
    Color(0xFF13538D),  // Темно-синій
...
// Daytime кольори
val daytimeColors = listOf(
    Color(0xFF003300),  // Темно-зелений
    Color(0xFF336666),  // Темно-сіро-зелений
    Color(0xFF336600)   // Темно-зелений
)

// Daytime кольори
val daytimeColors2 = listOf(
    Color(0xFF304A24),  // Темно-зелений
    Color(0xFF336666),  // Темно-сіро-зелений
    Color(0xFF336666)   // Темно-зелений
)