...
public class Subscription18Fragment extends SubscriptionFragment {

    private static final int DEFAULT_VIDEO = R.raw.vid_vibes_hands;
    ...
    private Subscription18Config config;
    ...
    public Subscription18Fragment() {
    }

    public static Subscription18Fragment newInstance(String from, String tag) {
        Subscription18Fragment fragment = new Subscription18Fragment();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_subscription_18, container, false);
    }
    ...
    protected void onPremiumPreSetup() {
        this.config = new Subscription18Config(activity);
    }
