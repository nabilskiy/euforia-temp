...
@Composable
fun VibesPlayerScreen(
    navController: NavHostController,
    viewModel: VibesPlayerViewModel
) {
...
@Composable
private fun VibesPlayerContent(playState: PlayState, onPause: () -> Unit, onPlay: () -> Unit) {
...
private fun handleSideEffect(sideEffect: VibesPlayerSideEffect) {
    when (sideEffect) {
        else -> {}
    }
}
